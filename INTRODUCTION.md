...
2.Overview of Spark optimization information on Spark
3.How can I user optimization information for my efficient implementation
4.Implementation of approach
5.Prepare large dataset for testing and comparing
6.Make meashures for comparing efficient of implementation
7.Write report.
